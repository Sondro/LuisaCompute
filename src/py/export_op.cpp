...
void export_op(py::module &m) {
    ...
    py::enum_<CallOp>(m, "CallOp")
        ...
        .value("GET_VERTEX_DATA", CallOp::GET_VERTEX_DATA)
		
        .value("CLEAR_DISPATCH_INDIRECT_BUFFER", CallOp::CLEAR_DISPATCH_INDIRECT_BUFFER)
        .value("EMPLACE_DISPATCH_INDIRECT_KERNEL1D", CallOp::EMPLACE_DISPATCH_INDIRECT_KERNEL1D)
        .value("EMPLACE_DISPATCH_INDIRECT_KERNEL2D", CallOp::EMPLACE_DISPATCH_INDIRECT_KERNEL2D)
        .value("EMPLACE_DISPATCH_INDIRECT_KERNEL3D", CallOp::EMPLACE_DISPATCH_INDIRECT_KERNEL3D)
