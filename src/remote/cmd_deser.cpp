		...
		*arr >> tag;
		switch (tag) {
			case Command::Tag::EBufferUploadCommand: {
				DeserCmdType(static_cast<BufferUploadCommand*>(i.get()));
			} break;
			case Command::Tag::EBufferDownloadCommand: {
				DeserCmdType(static_cast<BufferDownloadCommand*>(i.get()));
			} break;
			case Command::Tag::EBufferToTextureCopyCommand: {
				DeserCmdType(static_cast<BufferToTextureCopyCommand*>(i.get()));
			} break;
			case Command::Tag::EShaderDispatchCommand: {
				DeserCmdType(static_cast<ShaderDispatchCommand*>(i.get()));
			} break;
			case Command::Tag::ETextureUploadCommand: {
				DeserCmdType(static_cast<TextureUploadCommand*>(i.get()));
			} break;
			case Command::Tag::ETextureDownloadCommand: {
				DeserCmdType(static_cast<TextureDownloadCommand*>(i.get()));
			} break;
			case Command::Tag::ETextureCopyCommand: {
				DeserCmdType(static_cast<TextureCopyCommand*>(i.get()));
			} break;
			case Command::Tag::ETextureToBufferCopyCommand: {
				DeserCmdType(static_cast<TextureToBufferCopyCommand*>(i.get()));
			} break;
			case Command::Tag::EAccelBuildCommand: {
				DeserCmdType(static_cast<AccelBuildCommand*>(i.get()));
			} break;
			case Command::Tag::EMeshBuildCommand: {
				DeserCmdType(static_cast<MeshBuildCommand*>(i.get()));
			} break;
			case Command::Tag::EBindlessArrayUpdateCommand: {
				DeserCmdType(static_cast<BindlessArrayUpdateCommand*>(i.get()));
			} break;
			default:
