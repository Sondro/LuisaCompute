...
public:
     ...
     */
    [[nodiscard]] uint64_t create_mesh(uint64_t v_buffer, size_t v_offset, size_t v_stride, size_t v_count, uint64_t t_buffer, size_t t_offset, size_t t_count, AccelUpdateHint hint) noexcept override;
    /**
     ...
     */
    [[nodiscard]] uint64_t create_accel(AccelUpdateHint hint) noexcept override;
    /**
