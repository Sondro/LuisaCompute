...
spv_result_t SPV_API Link(const Context& context,
                          const spvstd::vector<vector<uint32_t>>& binaries,
                          spvstd::vector<uint32_t>* linked_binary,
