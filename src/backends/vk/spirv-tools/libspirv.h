...
typedef enum spv_operand_type_t {
  ...
  // Set 3:  The literal spvstd::string operand type.
...
#define LAST_VARIABLE(ENUM)                         \
  ...
  // An optional literal spvstd::string.
  ...
  // Packed spvstd::vector format
  SPV_OPERAND_TYPE_PACKED_VECTOR_FORMAT,  // SPIR-V Sec 3.x
  // An optional packed spvstd::vector format
...
// Returns the SPIRV-Tools software version as a null-terminated spvstd::string.
...
// Returns a null-terminated spvstd::string containing the name of the project,
// the software version spvstd::string, and commit details.
// The contents of the underlying storage is valid for the remainder of
// the process.
...
// Returns a spvstd::string describing the given SPIR-V target environment.
...
// - scalar alignment of a spvstd::vector is the scalar alignment of its component
